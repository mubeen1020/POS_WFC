                ...
                <CCard className="mb-4">
                    <CCardBody>
                        <DataTable
                            ...
                            <Column alignHeader={'center'} style={{ cursor: 'pointer' }} field="fish_ref" header="Fish" body={FishService.fishnameno} sortable></Column>
                            ...
                            <Column alignHeader={'center'} style={{ cursor: 'pointer' }} field="whole_fish_total_weight" header="Whole Fish Weight" sortable></Column>
                            <Column alignHeader={'center'} style={{ cursor: 'pointer' }} field="net_meat_total_weight" header="Net Meat Weight" sortable></Column>
                            <Column alignHeader={'center'} style={{ cursor: 'pointer' }} field="available_meat_packs" header="Available Meat Packs" sortable></Column>
                        </DataTable>
                    </CCardBody>
                </CCard>
            </CCol>
