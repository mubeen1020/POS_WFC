    ...
    const renderHeader = () => {
        return (
            <div className="flex justify-content-between">
                <span className="mb-3">
                    <h4><strong>Orders</strong><span className="d-grid gap-2 d-md-block" style={{ float: "right" }}>
                        <>
                ...
                <CCard className="mb-4">
                    <CCardBody>
                        <DataTable
                            ...
                            <Column alignHeader={'center'} style={{ cursor: 'pointer' }} field="urgent_delivery_charges" header="Urgent Delivery Charges (Rs)" ></Column>
