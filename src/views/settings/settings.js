                            ...
                            >
                                ...
                                <div >
                                    <CRow>
                                        ...
                                        <CCol sm={6} lg={6}>
                                            <CFormLabel htmlFor="validationCustomUsername">Max profit</CFormLabel>
                                            <CTooltip content="Kg" placement="left">
                                                <CFormInput
                                                    onChange={handlemaxprofit}
                                                    defaultValue={Settings.max_profit || Max_profit}
                                                    type="number"
                                                    id="validationCustomUsername"
                                                    aria-describedby="inputGroupPrepend"
                                                    required
                                            ...
                                            <CFormFeedback invalid>Please choose a Max profit.</CFormFeedback>
                                        </CCol>
                                    </CRow>
                                </div>
